...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, title=None, company=None, address=None, mobile=None, email=None, address2=None, id=None):
